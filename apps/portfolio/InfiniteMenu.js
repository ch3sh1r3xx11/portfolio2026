/**
 * InfiniteMenu.js — Vanilla JS port of the React InfiniteMenu component.
 * Depends on gl-matrix loaded globally via CDN before this script.
 * 
 * Usage:
 *   const menu = new InfiniteGridMenu(canvas, items, onActiveItemChange, onMovementChange, onInit, scale);
 *   menu.run();
 */
        ...
        item =>
          new Promise(resolve => {
            ...
            img.onerror = () => {
              ...
              fCtx.fillStyle = '#1D2C37';
              fCtx.fillRect(0, 0, 512, 512);
              fCtx.fillStyle = '#A9638B';
              fCtx.font = 'bold 48px monospace';
              fCtx.textAlign = 'center';
              fCtx.textBaseline = 'middle';
              fCtx.fillText(item.title || '?', 256, 256);
              resolve(fallback);
            };
            img.src = item.image;
          })
