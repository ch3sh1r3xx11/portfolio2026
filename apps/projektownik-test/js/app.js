...
import { initStrandsBg } from './strands-bg.js';

// Zainicjowanie animowanego tła
const bgLayer = document.querySelector('.bg-layer');
if (bgLayer) {
    try {
        initStrandsBg(bgLayer, {
            colors: ['#1d2c37', '#a9638b', '#25a3ad'],
            count: 3,
            speed: 0.1,
            amplitude: 1.3,
            waviness: 1,
        ...
        console.log("Strands BG initialized successfully.");
    } catch (err) {
        console.error("Failed to initialize Strands BG:", err);
    }
}
