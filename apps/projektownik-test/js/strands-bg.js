import { Renderer, Program, Mesh, Color, Triangle, RenderTarget } from 'https://unpkg.com/ogl';
...
export function initStrandsBg(container, options = {}) {
  const config = {
  ...
  const update = (t) => {
    ...
    // Check if configuration changed dynamically
